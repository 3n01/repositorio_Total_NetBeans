...
public class JL_TextoHoriz_Centr_Vert_3_Posiciones extends JFrame
{
    ...
    {
        JL_TextoHoriz_Centr_Vert_3_Posiciones obj = new JL_TextoHoriz_Centr_Vert_3_Posiciones();
    }

    public JL_TextoHoriz_Centr_Vert_3_Posiciones()
    {
        super("Texto en el centro y en las 3 alturas");
