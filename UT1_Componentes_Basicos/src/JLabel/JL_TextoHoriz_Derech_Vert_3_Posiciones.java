...
public class JL_TextoHoriz_Derech_Vert_3_Posiciones extends JFrame
{
    ...
    {
        new JL_TextoHoriz_Derech_Vert_3_Posiciones();
    }

    public JL_TextoHoriz_Derech_Vert_3_Posiciones()
    {
        super("Texto en la derecha y en las 3 alturas");
