...
public class JL_TextoImagen_PackIzq_9Combinaciones extends JFrame
{
    ...
    {
        JL_TextoImagen_PackIzq_9Combinaciones obj = new JL_TextoImagen_PackIzq_9Combinaciones();
    }

    public JL_TextoImagen_PackIzq_9Combinaciones()
    {
        ...
        //Crear la etiqueta
        lab1 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        lab2 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        lab3 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        add(lab3);
              ...
              //Crear la etiqueta
        lab4 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        lab5 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        lab6 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        add(lab6);
              ...
              //Crear la etiqueta
        lab7 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        lab8 = new JLabel("Texto", img, JLabel.LEFT);
        ...
        lab9 = new JLabel("Texto", img, JLabel.LEFT);
