...
public class JL_TextoImagen_PackDerech_9Combinaciones extends JFrame
{
    ...
    {
        JL_TextoImagen_PackDerech_9Combinaciones obj = new JL_TextoImagen_PackDerech_9Combinaciones();
    }

    public JL_TextoImagen_PackDerech_9Combinaciones()
    {
        ...
        ImageIcon img = new ImageIcon(getClass().getResource("..\\Recursos\\disco.png"));

        //Crear la etiqueta
        lab1 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        lab2 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        lab3 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        add(lab3);
              ...
              //Crear la etiqueta
        lab4 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        lab5 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        lab6 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        add(lab6);
              ...
              //Crear la etiqueta
        lab7 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        lab8 = new JLabel("Texto", img, JLabel.RIGHT);
        ...
        lab9 = new JLabel("Texto", img, JLabel.RIGHT);
